...
export default async function BlogPage() {
  ...
  return (
    <>
      <AdminHeader title="Blog" description={`${posts.length} Beiträge`} />
          ...
          <table className="w-full">
            <thead className="bg-[#0A0A0A]">
              <tr>
                ...
                <th className="text-left px-6 py-4 text-sm font-medium text-gray-400">Kategorie</th>
            ...
            <tbody className="divide-y divide-white/5">
              {posts.map((post) => (
                <tr key={post.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-6 py-4 text-gray-400 capitalize">{post.category || '-'}</td>
