...
import AboutSectionEditor from '@/components/admin/homepage/AboutSectionEditor';
import ServicesSectionEditor from '@/components/admin/homepage/ServicesSectionEditor';
import PortfolioSectionEditor from '@/components/admin/homepage/PortfolioSectionEditor';
import FotoboxSectionEditor from '@/components/admin/homepage/FotoboxSectionEditor';
import TestimonialsSectionEditor from '@/components/admin/homepage/TestimonialsSectionEditor';
import BlogSectionEditor from '@/components/admin/homepage/BlogSectionEditor';
import FAQSectionEditor from '@/components/admin/homepage/FAQSectionEditor';
import ContactSectionEditor from '@/components/admin/homepage/ContactSectionEditor';
...
export default function HomepageEditorPage() {
  ...
  return (
    <>
      <AdminHeader title="Startseite bearbeiten" />
