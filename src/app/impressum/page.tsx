...
export const metadata: Metadata = {
  title: 'Impressum | DZ-Photo',
  description: 'Impressum - Angaben gemäß § 5 TMG für Daniel Zangerle - DZ-Photo',
  robots: {
    index: true,
    follow: true,
  },
...
async function getImpressumPage() {
  try {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {page?.content ? (
              ...
              <div className="text-gray-300">
                <p>Die Impressum-Seite wird geladen...</p>
              </div>
            )}
          </div>
        </div>
